...
| フォルダー | 内容 |
| :--- | :--- |
| `templates/` | kintone アプリテンプレート 3 本(zip) |
...
1. **kintone システム管理 → 「アプリテンプレート」→「読み込む」** で、`templates/` の zip を読み込みます

   > システム管理者の権限が要ります。持っていない場合は、管理者に読み込みだけ依頼してください。アプリの作成自体は一般ユーザーでもできます

2. **「アプリを作成」→「テンプレートから作成」** で 3 つ作ります
...
フィールドの型・重複禁止・ドロップダウンの選択肢・ユーザー選択、それに記事で使う**カスタマイズ一覧**まで入った状態でできます。
